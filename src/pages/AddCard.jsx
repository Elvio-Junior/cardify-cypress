...
/*
Alterações
  1) Incluir identificador de classe .alert-error nos erros. Busca por estratégia de Classe.
     Exemplo
      {errors.number && (
        <p className="alert-error mt-1 text-xs text-red-400 ml-2">{errors.number}</p>
      )}
  2) Incluir identificador de Id para os campos de Input
     data-cy=
  3) Incluir identificador de classe .notice-success para cadastro com sucesso
